cc.Class({
    ...
    onLoad: function () {
     ...
     buttonClicked: function() {
        cc.log("buttonClicked BBBB");
         var self=this;
        if(this.userPw.string!==this.userPw1.string){
            this.showLabel.string='二次输入密码不一致';
        }else{
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "http://127.0.0.1:7777/userapi/regist?phone="+this.userName.string+"&passwd="+this.userPw.string+"&yzm="+this.yanzheng.string+"&tuijian=123", true);
     ...
     buttonClicked2: function() {
        ...
        var xhr = new XMLHttpRequest();
        xhr.open("GET", "http://127.0.0.1:7777/userapi/forgetpas?phone="+this.X_Account.string+"&passwd="+this.X_pas1.string+"&yzm="+this.yanzheng1.string+"&tuijian=123", true);
        xhr.setRequestHeader("Content-Type","application/x-www-form-urlencoded"); 
        xhr.send();
        xhr.onreadystatechange =function() 
        {
 ...
 //发送短信接口
    SendMessage:function(){
        ...
        var xhr = new XMLHttpRequest();
        xhr.open("GET","http://127.0.0.1:7777/userapi/phone?phone="+phone , true);
        xhr.setRequestHeader("Content-Type","application/x-www-form-urlencoded"); 
        xhr.send();
        xhr.onreadystatechange = function () 
        {
    ...
    buttonClicked1: function() {
        ...
        console.log(abc);
        xhr.open("GET", "http://127.0.0.1:7777/userapi/addMessage?"+abc, true);
        xhr.setRequestHeader("Content-Type","application/x-www-form-urlencoded"); 
